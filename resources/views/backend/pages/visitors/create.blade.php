            ...
            <div class="card-body">
                ...
                <form action="{{route('visitors.store')}}" method="post" enctype='multipart/form-data'>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-2">
                            <textarea class="form-control" id="store" name="store" placeholder="Enter Your Storey"></textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                   ...
                   <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="text"  class="form-control" id="contact_person" name="contact_person" placeholder="Enter Your Contact Person"/>
                        </div>
                    </div>
                    <div class="form-group row">
