...
@section('content')
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <a href="{{ route('investmoneys.investmoneyadd', $invest->id) }}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                @endif
                <form action="{{route('investmoneys.stored',$invest->id)}}" method="post">
                    @csrf
