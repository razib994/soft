            ...
            <div class="card-body">
                ...
                <form action="{{route('cashes.update', $other_expenditures->id)}}" method="post">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="number" value="{{$other_expenditures->date}}" class="form-control" id="date" name="date" placeholder="Date"/>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="amount" class="col-sm-3 col-form-label"> Amount </label>
                        <div class="col-sm-6">
                            <input type="number" value="{{$other_expenditures->amount}}" class="form-control" id="amount" name="amount" placeholder="Amount"/>
                        </div>
                    </div>
                    <div class="form-group row">
